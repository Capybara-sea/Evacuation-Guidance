export default {
  ...
  home: {
    // 外国人向け避難誘導
    question: 'Evakava Guidans Forregnas',
    // 災害時多言語情報
    info: 'Emergen Simurti-Rangua Gresalls',
  },
  content: {
    // 日本語はわかりますか?
    1: 'Entende japonês?',
    ...
    2: 'Que língua fala?',
    // 翻訳アプリ(参考)
    3: 'Pode consultar o seguinte software de tradução.',
    // 何か困っていることはありますか？
    4: 'Tem alguma coisa que o incomode?',
    // 欲しいものはありますか？
    5: 'Quer alguma coisa?',
  },
  image: {
  ...
  list: {
    ...
    help: {
      // 食べられないものがあります
      1: 'Não posso comer certa comida',
      // 長い間持っている病気があります
      2: 'Tenho uma doença crónica',
      // 妊娠しています
      3: 'Estou grávida',
      // 障害があります
      4: 'Tenho uma deficiência',
      // 体の調子が悪いです
      5: 'Não estou bem',
      // お祈りをしたいです
      6: 'Quero rezar',
      // 授乳をしたいです
      7: 'Eu gostaria de amamentar/engarrafar alimentar o meu bebê',
      // 短い間個室を使いたいです
      8: 'Eu gostaria de usar um quarto privado por um curto período de tempo',
      // ペットを連'れてきたいです
      9: 'Eu gostaria de trazer o meu(s) animal de estimação',
      //  Wi-Fiを使いたいです
      10: 'Eu gostaria de usar wi-fi',
      //  携帯電話を充電したいです
      11: 'Gostaria de carregar o meu telemóvel',
      //  家族に連絡したいです
      12: 'Gostaria de contactar a minha família',
      //  大使館に連絡したいです
      13: 'Gostaria de contactar a embaixada',
      //  すぐに帰国したいです
      14: 'Gostaria de voltar para o meu país imediatamente',
      //  移動方法を知りたいです
  ...
  result: {
    ...
    // 画像を長押しして保存する
    saveImage: 'Pressione e segure para salvar a imagem',
  },
  info: {
    // 参考サイト
