export default {
  ...
  home: {
    ...
    // 災害時多言語情報
    info: 'Ressources multilingues d’urgence',
  },
  content: {
    // 日本語はわかりますか?
    1: 'Comprenez-vous le japonais?',
    // 何語がわかりますか
    2: 'Quelle(s) langue(s) parlez-vous?',
    // 翻訳アプリ(参考)
    3: 'Vous pouvez vous référer au logiciel de traduction suivant.',
    // 何か困っていることはありますか？
  ...
  image: {
    ...
    listen:
      'Voice Tra est une application de traduction vocale multilingue pour smartphones.',
    // Google Translateは Google が提供する翻訳アプリです。
    google:
      'Google Translate est une application de traduction fournie par Google.',
  },
  button: {
    // はい
    yes: 'oui',
  ...
  list: {
    ...
    help: {
      // 食べられないものがあります
      1: 'Ikan Noit, Sertanford',
      // 長い間持っている病気があります
      2: 'Ihaf Akronic Irnes',
      // 妊娠しています
      3: 'Je suis enceinte',
      // 障害があります
      4: 'Ihaf Adisa Bylitti',
      // 体の調子が悪いです
      5: 'Imnowell',
      // お祈りをしたいです
      6: 'Je veux prier',
      // 授乳をしたいです
      7: 'Ivordeliktobresterfeld/Bottelfeld Maibabi',
      // 短い間個室を使いたいです
      8: 'Ivordliktous, Aprivatrum, Fuahotte',
      // ペットを連'れてきたいです
      9: 'Ivordelik Tobrin Meippet(s)',
      //  Wi-Fiを使いたいです
      10: 'Ivordliktouswi-Fi',
      //  携帯電話を充電したいです
      11: 'Ivordlikto, Chachmai, Mobile, Bonn',
      //  家族に連絡したいです
      12: 'Ivordelikto, Kantakt, Maifamili',
      //  大使館に連絡したいです
      13: 'Ivordelikto, Contactetern, Brésil',
      //  すぐに帰国したいです
      14: 'Ivordliktogo, Bacto, Mai Contri, Imei Dietli',
      //  移動方法を知りたいです
